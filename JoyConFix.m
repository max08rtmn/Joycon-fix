...
static void JCFLogStatus(NSString *phase) {
    NSLog(@"[JoyConFixReroute_STATUS] %@ active version=2026-06-30 pressed+value valueHook=%p pressedHook=%p controllers=%lu",
          phase,
...
static void JCFInit(void) {
    @autoreleasepool {
        NSLog(@"[JoyConFixReroute_STATUS] loaded 2026-06-30 pressed-and-value-reroute exact-button-match");
